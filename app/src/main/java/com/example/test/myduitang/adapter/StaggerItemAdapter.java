package com.example.test.myduitang.adapter;
...
import com.example.test.myduitang.bean.StaggerItem;
import com.example.test.myduitang.utils.BitmapUtils;
...
public class StaggerItemAdapter extends BaseAdapter {
    ...
    static class ViewHolder {
        @BindView(R.id.stagger_image) DynamicHeightImageView imageView;
        @BindView(R.id.thumb) ImageView thumbImage;
        @BindView(R.id.description) TextView description;
        @BindView(R.id.collect_number) Button collectNum;
        @BindView(R.id.collect_place) TextView collectPlace;
